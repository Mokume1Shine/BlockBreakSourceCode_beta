void Howtoplay(){
  ...
  text("Coin",1200,50);
  text("If you catch this,you get 10pt.",1200,300,200,100);
  text("Good Item",1500,50);
  text("If you catch this,you get Good effect.",1500,300,200,100);
  text("Bad Item",1800,50);
  text("If you catch this,you get Bad effect.",1800,300,200,100);
  stroke(255);
  strokeWeight(1);
  noFill();
  rect(0,70,200,200);
