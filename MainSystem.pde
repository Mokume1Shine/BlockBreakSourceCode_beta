void MainSystem(){
  ...
  if(RemainBlock==0){Menu=7;setting=true;}
  if(Balls==0){Menu=8;setting=true;}
  stroke(255);
  strokeWeight(1);
  fill(0);
...
void Rank(){
  ...
  }else if(Point<8200){RankText="S";
  }else if(Point<8400){RankText="SS";
  }else{RankText="SSS";}
}